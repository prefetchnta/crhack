...
mak/ccblkfn50.bat | ADI Visual DSP++ 5.0 (Naked-Blackfin)
mak/mdk40_16.bat | Keil MDK 4.0+ ARMCC (Naked-THUMB)
mak/mdk40_32.bat | Keil MDK 4.0+ ARMCC (Naked-ARM32)
mak/ndk-gcc.bat | Android NDK GCC (Android-ALL)
...
usr/arm-none-eabi-cm0p-small-ram.bat | GCC (for ARM Cortex-M0+ Small RAM)
usr/arm-none-eabi-cm3-big-ram.bat | GCC (for ARM Cortex-M3 Big RAM)
usr/arm-none-eabi-cm4f-big-ram.bat | GCC (for ARM Cortex-M4F Big RAM)
