...
call "%VS142COMNTOOLS%..\..\VC\Auxiliary\Build\vcvarsall.bat" x86
...
del GFX2_DX8.dll
del GFX3_D3D8.dll
move *.dll ..\bin\vc2019_win32_x86
move *.lib ..\bin\vc2019_win32_x86
del conf.inc

echo R_ADDONS= > conf.inc
echo C_ADDONS=/D "WIN64" /D "_WIN64" /I "..\inc\l3rd\dxsdk" /wd4819 /Oy- /WX- /Gm- /sdl /Zc:forScope /Zc:inline /fp:precise /arch:AVX /arch:AVX2 >> conf.inc
echo A_ADDONS= >> conf.inc
...
move *.dll ..\bin\vc2019_win32_x64
move *.lib ..\bin\vc2019_win32_x64
del conf.inc
