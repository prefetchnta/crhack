...
echo C_ADDONS=/D "WIN32" /D "_WIN32" /I "..\inc\l3rd\dxsdk" /wd4819 /Gd /Oy- /WX- /Gm- /Zc:forScope /Zc:inline /fp:precise /arch:SSE2 >> conf.inc
...
echo R_ADDONS= > conf.inc
echo C_ADDONS=/D "WIN64" /D "_WIN64" /I "..\inc\l3rd\dxsdk" /wd4819 /Oy- /WX- /Gm- /Zc:forScope /Zc:inline /fp:precise >> conf.inc
echo A_ADDONS= >> conf.inc
